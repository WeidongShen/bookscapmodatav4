...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "bookscapmv4listreport/test/integration/BooksSetListJourney.gen",
    "bookscapmv4listreport/test/integration/BooksSetObjectPageJourney.gen",
    "bookscapmv4listreport/test/integration/ChaptersSetObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
